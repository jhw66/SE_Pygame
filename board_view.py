...
class BoardView:
    ...
    @property
    def is_zoomed(self):
        return self.cell_size > self.fit_size + 1e-8

    def assign_colors(self, board, rng=None):
    ...
    def draw_arrow(self, surface, arrow, progress, color):
        ...
        for a, point, b in zip(points, points[1:], points[2:]):
